...
class Inicio():         #classe da Urna
    ...
    def confirma(self):        
        ...
        if self.labRecebe['text'] == '57':
            ...
            self.cursor.execute(f'INSERT INTO Kiera(numeroK) values("{num28}");')
            print("inseri o 28")
        elif self.labRecebe['text'] == '35':
            self.cursor.execute(f'INSERT INTO ChLauren(numeroCh) values("{num35}");')
            print("inseri o 35")
        else:            
            self.cursor.execute(f'INSERT INTO Nulo(numeroNulo) values("{num00}");')
            print("voto nulo")
        self.conexao.commit()
